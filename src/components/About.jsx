const About = () => {
  return (
    <div>
      <div>
        <button className="border px-4 py-1 rounded-3xl">Who we are</button>
        <h1 className="text-xl">We Help To Get Soultions</h1>
        <p>
        ...
        <button className="border px-3 py-1 bg-orange-300 rounded-xl">
          Learn more
        </button>
      </div>
      <div>
