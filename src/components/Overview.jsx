  ...
  return (
    <div className="flex items-center justify-between gap-6">
      ...
      <div className="flex flex-col gap-5 flex-1">
        ...
        <div className="flex gap-4">
          <div className="border rounded-3xl p-4 flex flex-col">
            ...
            <img
              src="../../public/Media/certificate.png"
              alt=""
              className="h-16 w-16"
            />
          </div>
          <div className="border rounded-3xl p-4">
            <h1 className="text-xl font-bold">
              4.8 <img src="../../public/Media/star.png" alt="" />
            </h1>
            <p>Over 20,000 Patient</p>
            <img src="../../public/Media/avatar.png" alt="" />
          </div>
          <div className="border rounded-3xl p-4">
            <h1 className="text-xl font-bold">$5000</h1>
            <p>Money spend for poor patient</p>
            <img
              src="../../public/Media/coin.png"
              alt=""
              className="h-16 w-16"
            />
          </div>
      ...
      <div className="border bg-zinc-50 p-4 rounded-3xl space-y-3">
        ...
        <img src="../../public/Media/video-icon.png" alt="" />
      </div>
    </div>
  )
}
